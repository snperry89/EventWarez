...
using EventWarez.WebAPI.Areas.HelpPage;
...
namespace DibzNote.WebAPI
{
    ...
    public class AddAuthorizationHeaderParameterOperationFilter : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            ...
            var isAuthorized = filterPipeline.Select(filterInfor => filterInfor.Instance).Any(filter => filter is IAuthorizationFilter);
        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    //
                    //c.CustomAsset("index", containingAssembly, "EventWarez.SwaggerExtensions.index.html");
